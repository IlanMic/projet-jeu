...
<div class="personnage-creation-form-container">
    ...
    <form class="creation-form" action="../Controllers/modifier-personnage.php" method = "POST" enctype="multipart/form-data">
        <div class="label-connexion-head">
            <h1>Modification du personnage: <?php echo $perso_a_modifier['nom_personnage']?> </h1>
            <hr>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">                
                    <div class="picture-container">
                        <?php
                            if(isset($perso_a_modifier['illustration'])) {
                                echo '<img class="card-img-top " id="edit-illustration" src="data:image/jpeg;base64,'.base64_encode( $perso_a_modifier['illustration'] ).'" alt="illustration"/>';
                            } else {
                                ?>
                        ...
                        <label id="label-upload" for="file-upload" class="custom-file-upload">
                            <i class="fa fa-cloud-upload"></i> Modifier l'illustration
                        </label>
                ...
                <div class="mb-4">
                    <br>
                    <label for="biographie">Bibilographie du personnage:</label>
                    <br>
                    <?php
                        if(strlen($perso_a_modifier['biographie'])<1) {
                            ?>
                                <textarea maxlength="300" name="biographie" placeholder="Saisissez la biographie de votre personnage..." class="textarea-bibliographie" cols="100%" rows="5%"></textarea>
                            <?php
                        } else {
                            ?>
                                <textarea maxlength="300" name="biographie" class="textarea-bibliographie" cols="100%" rows="5%"><?php echo $perso_a_modifier['biographie'] ?></textarea>
                            <?php   
                        }
                    ?>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-force">
                                ...
                                <br>
                                <input name="force" id="force" type="range" value="<?php $perso_a_modifier['strength'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['strength']; ?></output>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-defense">
                                ...
                                <br>
                                <input name="defense" id="defense" type="range" value="<?php $perso_a_modifier['defense'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['defense']; ?></output>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-tacle">
                                ...
                                <br>
                                <input name="tacle" id="tacle" type="range" value="<?php $perso_a_modifier['tacle'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['tacle']; ?></output>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-endurance">
                                ...
                                <br>
                                <input name="endurance" id="endurance" type="range" value="<?php $perso_a_modifier['endurance'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['endurance']; ?></output>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-technique">
                                ...
                                <br>
                                <input name="technique" id="technique" type="range" value="<?php $perso_a_modifier['technique'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['technique']; ?></output>
                            </div>  
                        </div>
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-vitesse">
                                ...
                                <br>
                                <input name="vitesse" id="vitesse" type="range" value="<?php $perso_a_modifier['vitesse'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['vitesse']; ?></output>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm">       
                            <div class="div-caracteristiques" id="carac-intelligence">
                                ...
                                <br>
                                <input name="intelligence" id="intelligence" type="range" value="<?php $perso_a_modifier['intelligence'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['intelligence']; ?></output>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-passe">
                                ...
                                <br>
                                <input name="passe" id="passe" type="range" value="<?php $perso_a_modifier['passe'] ?>" min="0" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['passe']; ?></output>
                            </div>
                        </div>
                        <div class="col-sm">
                            <div class="div-caracteristiques" id="carac-tir">
                                ...
                                <br>
                                <input name="tir" id="tir" type="range" value="0" min="<?php $perso_a_modifier['tir'] ?>" max="10" oninput="this.nextElementSibling.value = this.value">
                                <output><?php echo $perso_a_modifier['tir']; ?></output>
                            </div>
                        </div>
                    </div>

            ...
            <div class="card" id="card-2">
                <div class="row no-gutters">
                    <div class="card-body thin-margin">
                        <h5 class="card-title"><a class="a-title" href="profil-club.php?c=<?php echo $club_id ?>"><?php echo $club['nom_club']?></a></h5>
                        <hr>
                        <div class="row">
                            <div class="col-sm-7">
                                <br>
                                <p class="card-text">Propriétaire: <a class="a-title" href="profil-utilisateur.php?u=<?php echo $club['proprietaire_id'] ?>"><?php echo get_pseudo($club['proprietaire_id']) ?></a></p>
                                <br>
                                <br>
                            ...
                            <div class="col-sm-5">
                                <div class ="join-club-btn">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#join-club-<?php echo $club_id; ?>">
                                    Rejoindre ce club ?
                                    </button>
                                    <!-- Formulaire pour que le personnage sélectionné rejoigne le club -->
                                    <form action="../Controllers/rejoindre-club.php" method="POST">
                                        <!-- Modal -->
                                        <div class="modal fade" id="join-club-<?php echo $club_id; ?>" tabindex="-1" role="dialog" aria-labelledby="Rejoindre-ce-club" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        if($_SESSION['utilisateur_personnage_2'] != null) {
                                                            ?>
                                                            <div class="form-check">
                                                        ...
                                                        if($_SESSION['utilisateur_personnage_3'] != null){
                                                            ?>
                                                            <div class="form-check">

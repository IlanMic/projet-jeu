<?php
    ...
    if(isset($_POST['pseudo']) && isset($_POST['mail']) && isset($_POST['pass']) && isset($_POST['premium'])) {
        ...
        if(mot_de_passe_valide($pass)) {
            if(pseudo_est_unique($pseudo)) {
                if(mail_est_unique($mail)) {
                    ...
                    $_SESSION['etat'] = "Echec";
                    header('Location: ../Views/index.php');
                    $_SESSION['message'] = "Un utilisateur utilise déjà cette adresse mail.";
                }
            } else {
                $_SESSION['etat'] = "Echec";
                header('Location: ../Views/index.php');
                $_SESSION['message'] = "Un utilisateur utilise déjà ce pseudo.";                
            }
        } else {
            $_SESSION['etat'] = "Echec";
            header('Location: ../Views/index.php');

...
ALTER TABLE `projet_jeu`.`matchs` ADD `est_fini` TINYINT NOT NULL AFTER `club_2_joueur_7`;
ALTER TABLE `projet_jeu`.`matchs` ADD `a_commence` TINYINT NOT NULL AFTER `est_fini`;
ALTER TABLE `projet_jeu`.`matchs` CHANGE `club_1_id` `club_1_id` INT(11) NULL, CHANGE `club_2_id` `club_2_id` INT(11) NULL, CHANGE `date_match` `date_match` DATETIME NULL, CHANGE `score_club_1` `score_club_1` INT(11) NULL, CHANGE `score_club_2` `score_club_2` INT(11) NULL;


INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Gardien', '1', '4', '6', '7', '8', '2', '3', '7', '1', '7', '0', '0', NULL, NULL, NULL, '1', NULL, '1');
INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Défenseur Central 1', '4', '8', '9', '9', '10', '3', '4', '4', '5', '6', '0', '0', NULL, NULL, NULL, '2', NULL, '2'), (NULL, '[BOT] Défenseur Central 2', '3', '6', '7', '6', '8', '4', '6', '6', '6', '6', '0', '0', NULL, NULL, NULL, '2', NULL, '2');
INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Libéro', '2', '4', '9', '8', '9', '3', '3', '4', '2', '5', '0', '0', NULL, NULL, NULL, '2', NULL, '2');
INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Latéral 1', '2', '7', '6', '6', '6', '4', '9', '6', '4', '8', '0', '0', NULL, NULL, NULL, NULL, NULL, '2'), (NULL, '[BOT] Latéral 2', '2', '7', '6', '6', '6', '5', '7', '5', '3', '7', '0', '0', NULL, NULL, NULL, NULL, NULL, '2');
INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Milieu récupérateur', '4', '9', '8', '6', '4', '5', '6', '6', '6', '7', '0', '0', NULL, NULL, NULL, NULL, NULL, '3'), (NULL, '[BOT] Meneur de Jeu', '3', '6', '4', '3', '2', '8', '8', '9', '7', '9', '0', '0', NULL, NULL, NULL, NULL, NULL, '4');
INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Ailier 1', '1', '9', '6', '4', '4', '7', '8', '6', '6', '7', '0', '0', NULL, NULL, NULL, NULL, NULL, '3'), (NULL, '[BOT] Aillier 2', '4', '7', '5', '4', '2', '6', '9', '4', '7', '7', '0', '0', NULL, NULL, NULL, NULL, NULL, '3');
INSERT INTO `projet_jeu`.`personnage` (`id_personnage`, `nom_personnage`, `race_id`, `endurance`, `strength`, `tacle`, `defense`, `technique`, `vitesse`, `intelligence`, `tir`, `passe`, `experience`, `niveau`, `club_id`, `illustration`, `biographie`, `capacite_1_id`, `capacite_2_id`, `poste_id`) VALUES (NULL, '[BOT] Point d\'appui', '2', '4', '8', '3', '3', '5', '5', '6', '10', '7', '0', '0', NULL, NULL, NULL, NULL, NULL, '4');

INSERT INTO `projet_jeu`.`orientation` (`id_orientation`, `poste_id`, `nom_orientation`) VALUES (NULL, '2', 'Défenseur central');
CREATE TABLE `projet_jeu`.`composition` ( `id_composition` INT NOT NULL , `utilisateur_id` INT NOT NULL , `gardien_id` INT NOT NULL , `personnage_1_id` INT NOT NULL , `personnage_1_poste` INT NOT NULL , `personnage_1_orientation` INT NOT NULL , `personnage_2_id` INT NOT NULL , `personnage_2_poste` INT NOT NULL , `personnage_2_orientation` INT NOT NULL , `personnage_3_id` INT NOT NULL , `personnage_3_poste` INT NOT NULL , `personnage_3_orientation` INT NOT NULL , `personnage_4_id` INT NOT NULL , `personnage_4_poste` INT NOT NULL , `personnage_4_orientation` INT NOT NULL , `personnage_5_id` INT NOT NULL , `personnage_5_poste` INT NOT NULL , `personnage_5_orientation` INT NOT NULL , `personnage_6_id` INT NOT NULL , `personnage_6_poste` INT NOT NULL , `personnage_6_orientation` INT NOT NULL ) ENGINE = InnoDB;
ALTER TABLE `projet_jeu`.`composition` ADD PRIMARY KEY(`id_composition`);
ALTER TABLE `projet_jeu`.`composition` CHANGE `id_composition` `id_composition` INT(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `projet_jeu`.`composition` CHANGE `utilisateur_id` `personnage_utilisateur_id` INT(11) NOT NULL ;
ALTER TABLE `projet_jeu`.`matchs` CHANGE `club_1_id` `utilisateur_1_id` INT(11) NULL DEFAULT NULL, CHANGE `club_2_id` `utilisateur_2_id` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_1` `utilisateur_1_joueur_1` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_2` `utilisateur_1_joueur_2` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_3` `utilisateur_1_joueur_3` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_4` `utilisateur_1_joueur_4` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_5` `utilisateur_1_joueur_5` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_6` `utilisateur_1_joueur_6` INT(11) NULL DEFAULT NULL, CHANGE `club_1_joueur_7` `utilisateur_1_joueur_7` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_1` `utilisateur_2_joueur_1` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_2` `utilisateur_2_joueur_2` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_3` `utilisateur_2_joueur_3` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_4` `utilisateur_2_joueur_4` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_5` `utilisateur_2_joueur_5` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_6` `utilisateur_2_joueur_6` INT(11) NULL DEFAULT NULL, CHANGE `club_2_joueur_7` `utilisateur_2_joueur_7` INT(11) NULL DEFAULT NULL;
ALTER TABLE `projet_jeu`.`matchs` CHANGE `score_club_1` `score_utilisateur_1` INT(11) NULL DEFAULT NULL, CHANGE `score_club_2` `score_utilisateur_2` INT(11) NULL DEFAULT NULL;
ALTER TABLE `projet_jeu`.`matchs` ADD `poule_id` INT NULL AFTER `id_match`;
ALTER TABLE `projet_jeu`.`capacite` CHANGE `type` `type_capacite` VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL;